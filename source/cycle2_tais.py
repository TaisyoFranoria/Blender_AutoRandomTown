...
path_base = 'D:\\TBA\\base\\'
path_ex = 'D:\\TBA\\main\\ex\\1.fbx'
tail = '.fbx'
...
for x in range(100):
    ...
    path_br = path_base + str(0) + tail
    if(f2_mode):
        path_mr = path_m + '2f\\' + str(random.randint(0,3)) + tail
        path_rr = path_r + '2f\\' + str(random.randint(0,5)) + tail
